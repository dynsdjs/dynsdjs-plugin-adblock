(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("buffer"), require("stream"), require("url"), require("http"), require("https"), require("zlib"), require("string_decoder"), require("util"), require("os"));
	else if(typeof define === 'function' && define.amd)
		define(["buffer", "stream", "url", "http", "https", "zlib", "string_decoder", "util", "os"], factory);
	else if(typeof exports === 'object')
		exports["DynsdAdBlock"] = factory(require("buffer"), require("stream"), require("url"), require("http"), require("https"), require("zlib"), require("string_decoder"), require("util"), require("os"));
	else
		root["DynsdAdBlock"] = factory(root["buffer"], root["stream"], root["url"], root["http"], root["https"], root["zlib"], root["string_decoder"], root["util"], root["os"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_37__, __WEBPACK_EXTERNAL_MODULE_41__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ip__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_ip__);



function start( resolve, reject, data ) {
  __WEBPACK_IMPORTED_MODULE_0_node_fetch___default()( 'https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts' )
    .then( res => res.text() )
    .then( body => {
        body
          .split('\n')
              ...
              if ( !line.startsWith( '#' ) ) {
                ...
                data.entries
                  .set(
                    domain,
                    {
                      address: __WEBPACK_IMPORTED_MODULE_1_ip___default.a.address( 'private', 'ipv4' ),
                      address6: __WEBPACK_IMPORTED_MODULE_1_ip___default.a.address( 'private', 'ipv6' )
                    }
                  )
              }
            }
